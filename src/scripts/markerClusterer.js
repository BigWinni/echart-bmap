...
Cluster.prototype.updateClusterMarker = function() {
  ...
  this._clusterMarker.addEventListener && !this._clusterMarker._hasClickEvent && this._clusterMarker.addEventListener('click', function() {
